...
//GET CORRECT COMMAND
	public static String getCommand(Scanner scnr, String prompt) {
		...
		do {
			input = getString(scnr, "");
			if (input.equalsIgnoreCase("LIST") || input.matches(addRegex) || input.equalsIgnoreCase("QUIT")
...
//GET MODEL NAME
	public static String getModel(Scanner scnr, String prompt) {
		...
		do {
			...
			if (input.equalsIgnoreCase("model y") || input.equalsIgnoreCase("wrx") || input.equalsIgnoreCase("fusion")
					|| input.equalsIgnoreCase("rav4") || input.equalsIgnoreCase("equinox")
					|| input.equalsIgnoreCase("veloster")) {
				isValid = true;
			} else {
